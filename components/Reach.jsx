      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-6xl">
        {reach.map((item, ind) => {
          ...
          return (
            <div
              key={ind}
              className="group bg-white border dark:bg-gray-900 border-gray-200 rounded-3xl p-6 flex flex-col items-center text-center shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer"
            >
