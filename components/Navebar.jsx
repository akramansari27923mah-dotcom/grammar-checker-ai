        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 h-18 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              <div>
                <div
                  onClick={() => setAcountDilog(!accoutDilog)}
                  className="w-12 h-12 rounded-full overflow-hidden flex justify-center items-center uppercase bg-gray-100 cursor-pointer">
                  {user?.image ? (
                    <Image
                      src={user?.image}
                      alt={user.username}
                  ...
                  <div className="space-y-4 p-5">
                    ...
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-2">
                      <button
                        ...
                        className="mt-2 flex w-full items-center justify-between rounded-xl p-3 text-red-500 transition hover:bg-red-50 dark:hover:bg-red-900/20">
